...
class QuotesActivity : AppCompatActivity(), KodeinAware {
    ...
    private val viewModelFactory: QuotesViewModelFactory by instance() // ihtiyaç duyulduğunda üretilecek default olarak lazily
    ...
    private fun initializeUi() {
        ...
        // Eğer yaratılmışsa ekran döndürüldüğünde yeniden oluşmayacaktır ve veriler korunacak (lifecycle aware)
